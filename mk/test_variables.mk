...
INTEGRATIONTEST_DEBUG_OBJS := $(addprefix $(INTEGRATIONTEST_DEBUG_BUILD_DIR)/,$(INTEGRATIONTEST_CPP_SRC:.cpp=.o))
...
INTEGRATIONTEST_DEBUG_BIN := $(INTEGRATIONTEST_DEBUG_BUILD_DIR)/integration_test
